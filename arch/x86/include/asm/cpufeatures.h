...
#define X86_FEATURE_APERFMPERF                                                 \
	(3 * 32 +                                                              \
	 28) /* P-State hardware coordination feedback capability (APERF/MPERF MSRs) */
...
#define X86_FEATURE_RETPOLINE                                                  \
	(7 * 32 +                                                              \
	 12) /* "" Generic Retpoline mitigation for Spectre variant 2 */
...
#define X86_FEATURE_MSR_SPEC_CTRL                                              \
	(7 * 32 + 16) /* "" MSR SPEC_CTRL is implemented */
...
#define X86_FEATURE_SPEC_STORE_BYPASS_DISABLE                                  \
	(7 * 32 + 23) /* "" Disable Speculative Store Bypass. */
#define X86_FEATURE_LS_CFG_SSBD                                                \
	(7 * 32 + 24) /* "" AMD SSBD implementation via LS_CFG MSR */
#define X86_FEATURE_IBRS                                                       \
	(7 * 32 + 25) /* Indirect Branch Restricted Speculation */
#define X86_FEATURE_IBPB (7 * 32 + 26) /* Indirect Branch Prediction Barrier */
#define X86_FEATURE_STIBP                                                      \
	(7 * 32 + 27) /* Single Thread Indirect Branch Predictors */
#define X86_FEATURE_ZEN                                                        \
	(7 * 32 + 28) /* "" CPU is AMD family 0x17 or above (Zen) */
#define X86_FEATURE_L1TF_PTEINV                                                \
	(7 * 32 + 29) /* "" L1TF workaround PTE inversion */
#define X86_FEATURE_IBRS_ENHANCED (7 * 32 + 30) /* Enhanced IBRS */
#define X86_FEATURE_MSR_IA32_FEAT_CTL                                          \
	(7 * 32 + 31) /* "" MSR IA32_FEAT_CTL configured */
...
#define X86_FEATURE_EPT_AD                                                     \
	(8 * 32 + 17) /* Intel Extended Page Table access-dirty bit */
#define X86_FEATURE_VMCALL                                                     \
	(8 * 32 + 18) /* "" Hypervisor supports the VMCALL instruction */
#define X86_FEATURE_VMW_VMMCALL                                                \
	(8 * 32 + 19) /* "" VMware prefers VMMCALL hypercall instruction */
#define X86_FEATURE_PVUNLOCK (8 * 32 + 20) /* "" PV unlock function */
#define X86_FEATURE_VCPUPREEMPT                                                \
	(8 * 32 + 21) /* "" PV vcpu_is_preempted function */
...
#define X86_FEATURE_FDP_EXCPTN_ONLY                                            \
	(9 * 32 + 6) /* "" FPU data pointer updated only on x87 exceptions */
...
#define X86_FEATURE_ZERO_FCS_FDS                                               \
	(9 * 32 + 13) /* "" Zero out FPU CS and FPU DS */
...
#define X86_FEATURE_FENCE_SWAPGS_USER                                          \
	(11 * 32 + 4) /* "" LFENCE in user entry SWAPGS path */
#define X86_FEATURE_FENCE_SWAPGS_KERNEL                                        \
	(11 * 32 + 5) /* "" LFENCE in kernel entry SWAPGS path */
#define X86_FEATURE_SPLIT_LOCK_DETECT (11 * 32 + 6) /* #AC for split lock */
#define X86_FEATURE_PER_THREAD_MBA                                             \
	(11 * 32 + 7) /* "" Per-thread Memory Bandwidth Allocation */
#define X86_FEATURE_SGX1 (11 * 32 + 8) /* "" Basic SGX */
#define X86_FEATURE_SGX2                                                       \
	(11 * 32 + 9) /* "" SGX Enclave Dynamic Memory Management (EDMM) */
...
#define X86_FEATURE_RDPRU                                                      \
	(13 * 32 + 4) /* Read processor register at user level */
...
#define X86_FEATURE_AMD_STIBP_ALWAYS_ON                                        \
	(13 * 32 +                                                             \
	 17) /* "" Single Thread Indirect Branch Predictors always-on preferred */
#define X86_FEATURE_AMD_PPIN                                                   \
	(13 * 32 + 23) /* Protected Processor Inventory Number */
#define X86_FEATURE_AMD_SSBD                                                   \
	(13 * 32 + 24) /* "" Speculative Store Bypass Disable */
#define X86_FEATURE_VIRT_SSBD                                                  \
	(13 * 32 + 25) /* Virtualized Speculative Store Bypass Disable */
#define X86_FEATURE_AMD_SSB_NO                                                 \
	(13 * 32 + 26) /* "" Speculative Store Bypass is fixed in hardware. */
...
#define X86_FEATURE_WAITPKG                                                    \
	(16 * 32 + 5) /* UMONITOR/UMWAIT/TPAUSE Instructions */
#define X86_FEATURE_AVX512_VBMI2                                               \
	(16 * 32 +                                                             \
	 6) /* Additional AVX512 Vector Bit Manipulation Instructions */
...
#define X86_FEATURE_AVX512_BITALG                                              \
	(16 * 32 +                                                             \
	 12) /* Support for VPOPCNT[B,W] and VPSHUF-BITQMB instructions */
...
#define X86_FEATURE_SGX_LC                                                     \
	(16 * 32 + 30) /* Software Guard Extensions Launch Control */
...
#define X86_FEATURE_AVX512_VP2INTERSECT                                        \
	(18 * 32 + 8) /* AVX-512 Intersect for D/Q */
#define X86_FEATURE_SRBDS_CTRL                                                 \
	(18 * 32 + 9) /* "" SRBDS mitigation MSR available */
#define X86_FEATURE_MD_CLEAR (18 * 32 + 10) /* VERW clears CPU buffers */
#define X86_FEATURE_RTM_ALWAYS_ABORT                                           \
	(18 * 32 + 11) /* "" RTM transaction always aborts */
#define X86_FEATURE_TSX_FORCE_ABORT (18 * 32 + 13) /* "" TSX_FORCE_ABORT */
#define X86_FEATURE_SERIALIZE (18 * 32 + 14) /* SERIALIZE instruction */
#define X86_FEATURE_HYBRID_CPU                                                 \
	(18 * 32 + 15) /* "" This part has CPUs of more than one type */
#define X86_FEATURE_TSXLDTRK                                                   \
	(18 * 32 + 16) /* TSX Suspend Load Address Tracking */
...
#define X86_FEATURE_CORE_CAPABILITIES                                          \
	(18 * 32 + 30) /* "" IA32_CORE_CAPABILITIES MSR */
#define X86_FEATURE_SPEC_CTRL_SSBD                                             \
	(18 * 32 + 31) /* "" Speculative Store Bypass Disable */

/* AMD-defined memory encryption features, CPUID level 0x8000001f (EAX), word 19 */
#define X86_FEATURE_SME (19 * 32 + 0) /* AMD Secure Memory Encryption */
#define X86_FEATURE_SEV (19 * 32 + 1) /* AMD Secure Encrypted Virtualization */
#define X86_FEATURE_VM_PAGE_FLUSH                                              \
	(19 * 32 + 2) /* "" VM Page Flush MSR is supported */
#define X86_FEATURE_SEV_ES                                                     \
	(19 * 32 +                                                             \
	 3) /* AMD Secure Encrypted Virtualization - Encrypted State */
#define X86_FEATURE_SME_COHERENT                                               \
	(19 * 32 + 10) /* "" AMD hardware-enforced cache coherency */
...
#define X86_BUG_CLFLUSH_MONITOR                                                \
	X86_BUG(7) /* AAI65, CLFLUSH required before MONITOR */
...
#define X86_BUG_ESPFIX                                                         \
	X86_BUG(9) /* "" IRET to 16-bit SS corrupts ESP/RSP high bits */
#endif
#define X86_BUG_NULL_SEG X86_BUG(10) /* Nulling a selector preserves the base */
#define X86_BUG_SWAPGS_FENCE X86_BUG(11) /* SWAPGS without input dep on GS */
#define X86_BUG_MONITOR X86_BUG(12) /* IPI required to wake up remote CPU */
#define X86_BUG_AMD_E400                                                       \
	X86_BUG(13) /* CPU is among the affected by Erratum 400 */
#define X86_BUG_CPU_MELTDOWN                                                   \
	X86_BUG(14) /* CPU is affected by meltdown attack and needs kernel page table isolation */
#define X86_BUG_SPECTRE_V1                                                     \
	X86_BUG(15) /* CPU is affected by Spectre variant 1 attack with conditional branches */
#define X86_BUG_SPECTRE_V2                                                     \
	X86_BUG(16) /* CPU is affected by Spectre variant 2 attack with indirect branches */
#define X86_BUG_SPEC_STORE_BYPASS                                              \
	X86_BUG(17) /* CPU is affected by speculative store bypass attack */
#define X86_BUG_L1TF X86_BUG(18) /* CPU is affected by L1 Terminal Fault */
#define X86_BUG_MDS                                                            \
	X86_BUG(19) /* CPU is affected by Microarchitectural data sampling */
#define X86_BUG_MSBDS_ONLY                                                     \
	X86_BUG(20) /* CPU is only affected by the  MSDBS variant of BUG_MDS */
#define X86_BUG_SWAPGS                                                         \
	X86_BUG(21) /* CPU is affected by speculation through SWAPGS */
#define X86_BUG_TAA X86_BUG(22) /* CPU is affected by TSX Async Abort(TAA) */
#define X86_BUG_ITLB_MULTIHIT                                                  \
	X86_BUG(23) /* CPU may incur MCE during certain page attribute changes */
