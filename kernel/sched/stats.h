...
#define __update_stats_wait_start(rq, p, stats)                                \
	do {                                                                   \
	} while (0)
#define __update_stats_wait_end(rq, p, stats)                                  \
	do {                                                                   \
	} while (0)
#define __update_stats_enqueue_sleeper(rq, p, stats)                           \
	do {                                                                   \
	} while (0)
...
#define sched_info_enqueue(rq, t)                                              \
	do {                                                                   \
	} while (0)
#define sched_info_dequeue(rq, t)                                              \
	do {                                                                   \
	} while (0)
