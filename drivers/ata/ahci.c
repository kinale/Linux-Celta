...
static const struct pci_device_id ahci_pci_tbl[] = {
	...
	{ PCI_VDEVICE(INTEL, 0x2822),
	  board_ahci_nosntf }, /* ICH8/Lewisburg RAID*/
	...
	{ PCI_VDEVICE(INTEL, 0x2823),
	  board_ahci }, /* Wellsburg/Lewisburg AHCI*/
	{ PCI_VDEVICE(INTEL, 0x2827),
	  board_ahci }, /* Wellsburg/Lewisburg RAID*/
	...
	{ PCI_VDEVICE(INTEL, 0x02d3),
	  board_ahci_mobile }, /* Comet Lake PCH-U AHCI */
	{ PCI_VDEVICE(INTEL, 0x02d7),
	  board_ahci_mobile }, /* Comet Lake PCH RAID */
...
static int ahci_init_one(struct pci_dev *pdev, const struct pci_device_id *ent)
{
	...
	sysfs_add_file_to_group(&pdev->dev.kobj, &dev_attr_remapped_nvme.attr,
				NULL);
...
#ifdef CONFIG_ARM64
	if (pdev->vendor == PCI_VENDOR_ID_HUAWEI && pdev->device == 0xa235 &&
	    pdev->revision < 0x30)
