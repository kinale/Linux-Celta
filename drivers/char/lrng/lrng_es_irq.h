...
#define LRNG_DATA_SLOTS_PER_UINT                                               \
	(LRNG_DATA_ARRAY_MEMBER_BITS / LRNG_DATA_SLOTSIZE_BITS)
...
#define LRNG_DATA_ARRAY_SIZE (LRNG_DATA_NUM_VALUES / LRNG_DATA_SLOTS_PER_UINT)
