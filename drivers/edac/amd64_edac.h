...
#define dct_ganging_enabled(pvt)                                               \
	((boot_cpu_data.x86 == 0x10) && ((pvt)->dct_sel_lo & BIT(4)))
...
#define online_spare_swap_done(pvt, c)                                         \
	(((pvt)->online_spare >> (1 + 2 * (c))) & 0x1)
#define online_spare_bad_dramcs(pvt, c)                                        \
	(((pvt)->online_spare >> (4 + 4 * (c))) & 0x7)
...
#define SET_NB_DRAM_INJECTION_WRITE(inj)                                       \
	(BIT(((inj.word) & 0xF) + 20) | F10_NB_ARR_ECC_WR_REQ | inj.bit_map)
#define SET_NB_DRAM_INJECTION_READ(inj)                                        \
	(BIT(((inj.word) & 0xF) + 20) | BIT(16) | inj.bit_map)
