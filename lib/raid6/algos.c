...
const struct raid6_recov_calls *const raid6_recov_algos[] = {
	...
	&raid6_recov_avx512,
#endif
	&raid6_recov_avx2,   &raid6_recov_ssse3,
#endif
#ifdef CONFIG_S390
	&raid6_recov_s390xc,
#endif
...
static inline const struct raid6_calls *
raid6_choose_gen(void *(*const dptrs)[RAID6_TEST_DISKS], const int disks)
{
	unsigned long perf, bestgenperf, bestxorperf, j0, j1;
	int start = (disks >> 1) - 1,
	    stop = disks - 3; /* work on the second half of the disks */
